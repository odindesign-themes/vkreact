...
add_action('wp_ajax_nopriv_vkreact_create_postcomment_user_reaction_ajax', 'vkreact_create_postcomment_user_reaction_ajax');
...
add_action('wp_ajax_nopriv_vkreact_delete_postcomment_user_reaction_ajax', 'vkreact_delete_postcomment_user_reaction_ajax');
